...
my @col_testpage=('privname');
my $name_test="iiprivlist";

my @col_dbschema=('\'$NODBNAME$\'','b.table_name','b.column_name','b.column_datatype');
my $name_dbschema="iitables a left join iicolumns b on a.table_name=b.table_name";
my $name_dbschematail="a.system_use='U'";
