...
#Tested in MonetDB Server v5.0.0
my $version="v5.0.0";
...
my @col_testpage=('id','name');
my $name_test="sys.auths";

my @col_dbschema=('c.name','b.name','a.name','a.type');
my $name_dbschema="sys.columns a inner join sys.tables b on (a.table_id=b.id) inner join sys.schemas c on b.schema_id=c.id";
my $name_dbschematail="system=false";
