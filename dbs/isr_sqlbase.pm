...
#Tested in sqlbase Ltd Version 9.0.1
...
my @col_testpage=('TCREATOR','TTNAME');
my $name_test="SYSSQL.SYSTABAUTH";

my @col_dbschema=('TBCREATOR','TBNAME','NAME','COLTYPE');
my $name_dbschema="SYSSQL.SYSCOLUMNS";
