package isr_thinksql;
use Data::Dump qw(dump);

#Author: Francisco Amato

#Tested in ThinkSQL Ltd Version 01.04.00
...
#select table_schema,table_name,column_name,data_type,char(41) from information_schema.columns;
my @col_testpage=('CATALOG_NAME','SCHEMA_NAME','SCHEMA_OWNER');
my $name_test="INFORMATION_SCHEMA.SCHEMATA";

my @col_dbschema=('TABLE_SCHEMA','TABLE_NAME','COLUMN_NAME','DATA_TYPE');
my $name_dbschema="INFORMATION_SCHEMA.COLUMNS";
