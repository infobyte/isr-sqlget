...
$conf::script="example1.php";  	      	      #Script file vulnerable
...
$conf::session="example1";  #Session name (You have to use the same name of the session config file without .pm extension)
