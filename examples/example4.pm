...
$conf::script="example4.php";  	      	      #Script file vulnerable
...
$conf::session="example4";  #Session name (You have to use the same name of the session config file without .pm extension)
