...
$conf::script="example5.php";  	      	      #Script file vulnerable
...
$conf::session="example5";  #Session name (You have to use the same name of the session config file without .pm extension)
