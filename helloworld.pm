...
$conf::script="helloworld.php";  	      #Script file vulnerable
...
$conf::session="helloworld";  #Session name (You have to use the same name of the session config file without .pm extension)
